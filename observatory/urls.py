...
urlpatterns = [
    ...
    path("api/stations/<str:code>/track/", api.station_track, name="api_track"),
    ...
    path("api/outside-region/", api.outside_region, name="api_outside_region"),
    path("api/outside-region/purge/", api.outside_region_purge, name="api_outside_region_purge"),
